...
/**
 * _Freform _Freform1 Model
 */
class _FreformModel_Freform1 extends JModelAdmin
{
    /**
    ...
    public function save($data)
    {
        ...
        if (in_array($input->get('task'), array('apply', 'save', 'save2new'))) {
            if (empty($data['alias'])) {
                ...
                list($title, $alias) = $this->generateNew_Freform1Title($data['alias'], $data['title']);
                $data['alias'] = $alias;
    ...
    protected function loadFormData()
    {
        ...
        $data = JFactory::getApplication()->getUserState(
            'com__freform.edit._freform.data',
            array()
        );
