...
:promptname
set /p Nm= Enter new component name (e.g. Alerts, People):

if [%Nm%]==[] goto checksingular

:promptsingular
set /p Sn= Enter new component name (e.g. Alert, Person):
...
php -f _build-new-freform/index.php owner=%Ow% name=%Nm% singular=%Sn% description=%Ds%
