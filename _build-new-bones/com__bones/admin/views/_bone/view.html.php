...
class _BonesView_Bone extends JViewLegacy
{
    ...
    protected function addToolBar()
    {
        ...
        if ($isNew && (count($user->getAuthorisedCategories('com__bones', 'core.create')) > 0)) {
            ...
            JToolbarHelper::save('_bone.save');
            JToolbarHelper::save2new('_bone.save2new');
            JToolbarHelper::cancel('_bone.cancel');
        } else {
            ...
            if ($canDo->get('core.create')) {
                JToolbarHelper::save2copy('_bone.save2copy');
            }


            JToolbarHelper::cancel('_bone.cancel', 'JTOOLBAR_CLOSE');
        }
    }
    /**
