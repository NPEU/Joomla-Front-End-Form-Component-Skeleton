...
namespace NPEU\Component\Alerts\Administrator\Table;
 ...
 * @since  1.0
 */
#class AlertTable extends Nested implements VersionableTableInterface, TaggableTableInterface
class AlertTable extends Table
{
    #use TaggableTableTrait;

    public function __construct(DatabaseDriver $db) {
        $this->typeAlias = 'com_alerts.alert';

        parent::__construct('#__alerts', 'id', $db);
    ...
    public function bind($array, $ignore = '') {
        ...
        /*if (isset($array['parent_id'])) {
			...
			elseif (isset($array['alertsordering']))
			{
	...
	protected function _getAssetName() {
		$k = $this->_tbl_key;
		return 'com_alerts.alert.'.(int) $this->$k;
	}
	/**
