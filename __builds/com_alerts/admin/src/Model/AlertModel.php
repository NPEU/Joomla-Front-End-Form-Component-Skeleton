...
namespace NPEU\Component\Alerts\Administrator\Model;
 ...
 * Alerts Alert Model
 */
class AlertsModelAlert extends AdminModel
{
    /**
     ...
     */
    public function getTable($type = 'Alerts', $prefix = 'AlertsTable', $config = array())
    {
    ...
    public function save($data)
    {
        ...
        if (in_array($input->get('task'), array('apply', 'save', 'save2new'))) {
            if (empty($data['alias'])) {
                ...
                $table = JTable::getInstance('Alerts', 'AlertsTable');
     ...
     * @return  array  Contains the modified title and alias.
     */
    /*protected function generateNewAlertsTitle($alias, $title)
    {
        // Alter the title & alias
        $table = $this->getTable();
    ...
    {
        #return 'administrator/components/com_alerts/models/forms/alerts.js';
        return '';
    }*/
